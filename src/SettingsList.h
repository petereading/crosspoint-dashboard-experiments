    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_LOCK_SCREEN_TYPE, &CrossPointSettings::sleepLockScreenType,
                          {StrId::STR_CLOCK_DASHBOARD, StrId::STR_WEATHER_DASHBOARD, StrId::STR_CUSTOM_IMAGE_DASHBOARD,
                           StrId::STR_MOON_DASHBOARD, StrId::STR_RSS_DASHBOARD, StrId::STR_TODAY_DASHBOARD,
                           StrId::STR_QUOTE_DASHBOARD, StrId::STR_BITCOIN_DASHBOARD, StrId::STR_SOLAR_DASHBOARD},
        ...
        SettingInfo::Value(StrId::STR_MOON_REFRESH_INTERVAL, &CrossPointSettings::moonRefreshMinutes, {15, 240, 15},
                           "moonRefreshMinutes", StrId::STR_CAT_SYSTEM),
        SettingInfo::Value(StrId::STR_RSS_REFRESH_INTERVAL, &CrossPointSettings::rssRefreshMinutes, {5, 240, 5},
                           "rssRefreshMinutes", StrId::STR_CAT_SYSTEM),
        SettingInfo::Value(StrId::STR_TODAY_REFRESH_INTERVAL, &CrossPointSettings::todayRefreshMinutes, {15, 240, 15},
                           "todayRefreshMinutes", StrId::STR_CAT_SYSTEM),
        SettingInfo::Value(StrId::STR_QUOTE_REFRESH_INTERVAL, &CrossPointSettings::quoteRefreshMinutes, {15, 240, 15},
                           "quoteRefreshMinutes", StrId::STR_CAT_SYSTEM),
        SettingInfo::Value(StrId::STR_BITCOIN_REFRESH_INTERVAL, &CrossPointSettings::bitcoinRefreshMinutes, {5, 240, 5},
                           "bitcoinRefreshMinutes", StrId::STR_CAT_SYSTEM),
        SettingInfo::Value(StrId::STR_SOLAR_REFRESH_INTERVAL, &CrossPointSettings::solarRefreshMinutes, {15, 240, 15},
                           "solarRefreshMinutes", StrId::STR_CAT_SYSTEM),
        SettingInfo::Enum(StrId::STR_BITCOIN_CURRENCY, &CrossPointSettings::bitcoinCurrency,
                          {StrId::STR_CURRENCY_USD, StrId::STR_CURRENCY_GBP, StrId::STR_CURRENCY_EUR},
                          "bitcoinCurrency", StrId::STR_CAT_SYSTEM),
        ...
        SettingInfo::String(StrId::STR_RSS_FEED_URL, SETTINGS.rssFeedUrl, sizeof(SETTINGS.rssFeedUrl), "rssFeedUrl",
                            StrId::STR_LOCK_SCREENS),
        SettingInfo::String(StrId::STR_RSS_FEED_TITLE, SETTINGS.rssFeedTitle, sizeof(SETTINGS.rssFeedTitle),
                            "rssFeedTitle", StrId::STR_LOCK_SCREENS),
        SettingInfo::String(StrId::STR_TODAY_LANGUAGE, SETTINGS.todayLanguage, sizeof(SETTINGS.todayLanguage),
                            "todayLanguage", StrId::STR_LOCK_SCREENS),
        ...
        SettingInfo::Toggle(StrId::STR_AUTO_TIMEZONE, &CrossPointSettings::clockTzAutoDetect, "clockTzAutoDetect",
                            StrId::STR_CUSTOMISE_STATUS_BAR),
